  ...
  const aiTools = [
    {
      ...
      icon: (
        <svg viewBox="0 0 512 512" width="30" height="30" fill="none" stroke="currentColor" stroke-Width="2">
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-Width="1" stroke="currentColor">
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-Width="0.2" stroke="currentColor">
    ...
    },
    {
      ...
      icon: (
        <svg fill="none" viewBox="0 0 48 48" fill="none" stroke-Width="0.4" stroke="currentColor">
