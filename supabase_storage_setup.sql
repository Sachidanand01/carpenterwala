-- ==========================================================
-- Supabase Storage Setup: Public Assets & Private KYC Docs
-- ==========================================================
...
-- 3. Storage Policies (Row Level Security is already enabled on storage.objects by default)
...
-- Policy E: Private KYC reads only via Service Role or Signed URLs (default behavior for private buckets)
-- (No public SELECT policy on kyc-documents bucket ensures zero unauthenticated URL leaks)
