...
export async function generateMetadata({ searchParams }) {
  ...
  let title = 'Pro Portal - Register as a Service Pro';
  ...
  if (lang === 'hi') {
    title = 'Pro Portal - रजिस्टर करें और ग्राहक पाएं';
    ...
    title = 'Pro Portal - ನೋಂದಾಯಿಸಿ ಗ್ರಾಹಕರನ್ನು ಪಡೆಯಿರಿ';
    ...
    title = 'Pro Portal - பதிவு செய்து வாடிக்கையாளர்களைப் பெறுங்கள்';
    ...
    title = 'Pro Portal - నమోదు చేసుకోండి కస్టమర్లను పొందండి';
  ...
  return {
    ...
    alternates: {
      canonical: ['hi', 'kn', 'ta', 'te'].includes(lang) ? `/pro/login?lang=${lang}` : '/pro/login',
      languages: {
        'en': '/pro/login',
        'hi': '/pro/login?lang=hi',
        'kn': '/pro/login?lang=kn',
        'ta': '/pro/login?lang=ta',
        'te': '/pro/login?lang=te',
        'x-default': '/pro/login',
      },
    },
  };
